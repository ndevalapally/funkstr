...
-(NSString*)sendMessage:(NSString*)text
{
    ...
    body.text = [text stripXMLTags] ;//[text xmlSafe];
    [element.children addObject:body];
    [element.children addObject:active];
...
-(void)sendTypingState:(DCTypingState)state
{
    ...
    [element.children addObject:stateElement];
...
-(void)getVCard
{
    ...
    [element.children addObject:vcard];
    [stream sendStanza:element];
}
////////////////////////////////////////////////////////////////////////////////////////////////////
-(void)getPresence
...
-(void)join
{
    if(!self.isJoined)
    {
        ...
        [xElement.children addObject:history];
        [stream sendStanza:element];
        _isJoined = YES;
